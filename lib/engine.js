 ...
 *
 * Over de strafpunten: een fout antwoord kost iets, maar niet zo veel
 * dat zwijgen slimmer wordt dan meedoen. Waar het echt om te doen is,
 * zijn de rondes waar je mag blijven raden — daar kostte machinegeweer-
 * gokken vroeger niets. Elke misgok telt daar apart, met een bodem
 * zodat één ronde niemand de das omdoet.
 */
export const PUNTEN = {
  basis: { mc: 100, woord: 100, truefalse: 60, open: 120, geo: 120 },
  fout: { mc: -20, woord: -20, truefalse: -15, open: -20, geo: -20 },
