...
export function hostBeeld(spel) {
  ...
  return {
    ...
    // alle foto's alvast op te halen, zodat er later geen gat valt.
    fotosVooraf: spel.fase === 'lobby' ? Object.values(FOTOS).map((f) => f.bestand) : null,
    stand: stand(spel),
  };
}
